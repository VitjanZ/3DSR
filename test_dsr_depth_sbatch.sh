#!/bin/sh
#SBATCH --job-name=test_dsr_depth
#SBATCH --output=./outputs/test_dsr_depth.out
...
srun --nodes=1 --exclusive --gres=gpu:1 --ntasks=1 --unbuffered python test_dsr_depth.py --gpu_id 0 --data_path $MVTEC3D_PATH --out_path $CHKP_PATH --run_name $RUN_NAME &
